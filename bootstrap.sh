...
note 'step 1/10: Determinate Nix'
...
note 'step 2/10: stable dotfiles path'
...
note 'step 4/10: nix-darwin and Home Manager'
...
note 'step 6/10: additive Claude Code and Codex'
...
note 'step 10/10: complete macOS permission guide'
